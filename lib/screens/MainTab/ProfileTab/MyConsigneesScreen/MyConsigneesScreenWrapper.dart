...
import 'MyConsigneesScreenController.dart';

class MyConsigneesScreen extends BaseView<MyConsigneesScreenController> {
  const MyConsigneesScreen({super.key});
            ...
            children: [
              ...
              Container(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: AppColors().newBlueColor),
                ),
              ...
              Container(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: AppColors().newAppDarkRedColor),
                ),
                height: 4.h,
                width: 15.w,
              ...
              Column(
                ...
                children: [
                  ...
                  Container(
                    width: 45.w,
                    child: Text(
                      "104 New Avenue, New Town, Street, Boston, USA",
                      maxLines: 2,
                      style: TextStyle(
                        fontFamily: Appfonts.family1SemiBold,
                        fontSize: 15.sp,
