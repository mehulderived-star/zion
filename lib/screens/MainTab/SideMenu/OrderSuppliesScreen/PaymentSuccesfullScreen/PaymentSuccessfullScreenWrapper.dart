...
import 'PaymentSuccessfullScreenController.dart';

class PaymentSuccessfullScreen
    extends BaseView<PaymentSuccessfullScreenController> {
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            headerView(context),
            Spacer(),
            Image.asset(AppImages.successfullImage, height: 15.h, width: 15.h),
            SizedBox(height: 2.h),
            Text(
